  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] text-[#E1E1E3] font-mono selection:bg-emerald-500/30">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 space-y-8">
                    ...
                    >
                      <div className="flex flex-col sm:flex-row">
                        ...
                        <div className="p-4 bg-black/20 flex items-center justify-center">
                          <ChevronRight className="w-5 h-5 text-white/10 group-hover:text-emerald-500 transition-colors" />
                        </div>
                      </div>
                    </motion.div>
                  ))}
        ...
        {error && (
          <div className="p-4 bg-red-500/10 border border-red-500/50 rounded-lg text-red-500 text-sm flex items-center gap-3">
            <AlertTriangle className="w-5 h-5" />
            {error}
          </div>
        )}
